...
if ( ! class_exists( 'WC_Gateway_PAFW_Settlevbank' ) ) {
	...
	class WC_Gateway_PAFW_Settlevbank extends WC_Gateway_PAFW {
		public function __construct() {
			...
			$this->title              = __( '세틀뱅크 010가상계좌', 'pgall-for-woocommerce' );
			$this->method_title       = __( '세틀뱅크 010가상계좌', 'pgall-for-woocommerce' );
			$this->method_description = '<div style="font-size: 0.9em;">세틀뱅크 010가상계좌 서비스를 이용합니다.</div>';
