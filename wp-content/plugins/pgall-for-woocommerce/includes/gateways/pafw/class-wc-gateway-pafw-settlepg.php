...
if ( ! class_exists( 'WC_Gateway_PAFW_SettlePG' ) ) {
	...
	class WC_Gateway_PAFW_SettlePG extends WC_Gateway_PAFW {
		public function __construct() {
			...
			$this->title              = __( '세틀뱅크 전자결제(PG)', 'pgall-for-woocommerce' );
			$this->method_title       = __( '세틀뱅크 전자결제(PG)', 'pgall-for-woocommerce' );
			$this->method_description = '<div style="font-size: 0.9em;">세틀뱅크  전자결제(PG) 서비스를 이용합니다.</div>';
