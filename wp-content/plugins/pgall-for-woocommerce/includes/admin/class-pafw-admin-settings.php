						...
						'elements' => apply_filters( 'pafw_admin_gateway_settings',
							array(
								...
								array(
									...
									"type"      => "Toggle",
									"default"   => "no",
									"desc"      => __( '<div class="desc2">토스페이먼츠 결제 시스템을 이용 합니다.</div>', 'pgall-for-woocommerce' ),
									"action"    => array(
										"icon"   => "cogs",
										"show"   => "yes",
										"target" => "_blank",
								...
								array(
									...
									"title"     => __( "세틀뱅크 내통장결제", "pgall-for-woocommerce" ),
									"className" => "",
									"type"      => "Toggle",
									"default"   => "no",
									"desc"      => __( '<div class="desc2">세틀뱅크 내통장결제 시스템을 이용합니다.</div>', 'pgall-for-woocommerce' ),
									"action"    => array(
										"icon"   => "cogs",
										"show"   => "yes",
										"target" => "_blank",
								...
								array(
									...
									"title"     => __( "세틀뱅크 010가상계좌", "pgall-for-woocommerce" ),
									"className" => "",
									"type"      => "Toggle",
									"default"   => "no",
									"desc"      => __( '<div class="desc2">세틀뱅크 010가상계좌 결제 시스템을 이용합니다.</div>', 'pgall-for-woocommerce' ),
									"action"    => array(
										"icon"   => "cogs",
										"show"   => "yes",
										"target" => "_blank",
								...
								array(
									"id"        => "pafw-gw-settlepg",
									"title"     => __( "세틀뱅크 전자결제(PG)", "pgall-for-woocommerce" ),
									"className" => "",
									"type"      => "Toggle",
									"default"   => "no",
									"desc"      => __( '<div class="desc2">세틀뱅크 전자결제(PG) 결제 시스템을 이용합니다.</div>', 'pgall-for-woocommerce' ),
									"action"    => array(
										"icon"   => "cogs",
										"show"   => "yes",
										"target" => "_blank",
								...
								array(
									"id"        => "pafw-gw-npay",
									"title"     => __( "네이버페이", "pgall-for-woocommerce" ),
									"className" => "",
									"type"      => "Toggle",
									"default"   => "no",
									"desc"      => __( '<div class="desc2">네이버페이 결제 시스템을 이용합니다. (간편결제, 반복정기결제)</div>', 'pgall-for-woocommerce' ),
									"action"    => array(
										"icon"   => "cogs",
										"show"   => "yes",
										"target" => "_blank",
		...
		static function get_cash_receipt_setting() {
			return array(
				...
				'elements' => array(
					array(
						...
						'elements' => array(
							array(
								...
								'readonly'  => 'yes',
								'default'   => '',
								'desc2'     => __( '현금영수증 자동 발급 기능은 <span style="color: #2185d0">KG 이니시스</span>, <span style="color: #2185d0">KCP</span>, <span style="color: #2185d0">나이스페이</span> 결제대행사를 사용하는 경우에만 이용할 수 있습니다.', 'pgall-for-woocommerce' ),
							),
							array(
								"id"        => "pafw_use_bacs_receipt",
								"title"     => __( "현금영수증 자동 발급", "pgall-for-woocommerce" ),
								"className" => "",
								'showIf'    => array( 'pafw-gw-inicis' => 'yes', 'pafw-gw-kcp' => 'yes', 'pafw-gw-nicepay' => 'yes' ),
								"type"      => "Toggle",
								"default"   => "no",
							...
							array(
								...
								"className" => "",
								'showIf'    => array( array( 'pafw-gw-inicis' => 'yes', 'pafw-gw-kcp' => 'yes', 'pafw-gw-nicepay' => 'yes' ), array( 'pafw_bacs_always_issue_receipt' => 'yes' ) ),
								"type"      => "LabeledInput",
					...
					array(
						'type'     => 'Section',
						'showIf'   => array( array( 'pafw-gw-inicis' => 'yes', 'pafw-gw-kcp' => 'yes', 'pafw-gw-nicepay' => 'yes' ), array( 'pafw_use_bacs_receipt' => 'yes' ) ),
