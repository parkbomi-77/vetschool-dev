				...
				array (
					...
					'elements' => array (
						...
						array (
							...
							'type'      => 'Text',
							'default'   => 'INIpayTest',
							'desc2'     => __( '<div class="desc2">결제 테스트용 상점 아이디는 <code>INIpayTest</code> 입니다.<br>실 결제용 상점 아이디는 <code>CIG</code>로 시작해야 합니다. 기존에 발급받은 <code>COD</code> 또는 <code>MOD</code>로 시작하는 상점 아이디도 사용하실 수 있습니다.</div>', 'pgall-for-woocommerce' ),
						),
						array (
							'id'        => 'signkey',
							'title'     => '웹표준 사인키',
							'showLike'  => array ( 'merchant_id' => '!CIG,!CIS' ),
							'className' => 'fluid',
							'default'   => '',
				...
				array (
					...
					'elements' => array (
						...
						array (
							...
							'default'   => 'INIBillTst',
							'type'      => 'Text',
							'desc2'     => __( '<div class="desc2">결제 테스트용 상점 아이디는 <code>INIBillTst</code> 입니다.<br>실 결제용 상점 아이디는 <code>CIS</code>로 시작해야 합니다.</div>', 'pgall-for-woocommerce' ),
						),
						array (
							'id'        => 'subscription_signkey',
							'showLike'  => array ( 'subscription_merchant_id' => '!CIS' ),
							'title'     => '웹표준 사인키',
							'className' => 'fluid',
							'default'   => '',
							'type'      => 'Text',
