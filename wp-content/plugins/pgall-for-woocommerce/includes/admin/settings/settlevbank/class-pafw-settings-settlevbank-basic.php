				...
				array (
					...
					'elements' => array (
						...
						array (
							...
							'type'      => 'Text',
							'default'   => '',
							'desc2'     => __( '<div class="desc2">세틀뱅크 가입 후 전달받으신 암호키를 입력해주세요.<br>결제 테스트를 위한 가맹점 암호화키 발급은 <code><a target="_blank" href="https://develop.sbsvc.online/">세틀뱅크 개발자 사이트</a></code>에서 신청하실 수 있습니다.</code></div>', 'pgall-for-woocommerce' ),
						),
						array (
							'id'        => 'license_key',
							'title'     => '라이센스키',
							...
							'type'      => 'Text',
							'default'   => '',
							'desc2'     => __( '<div class="desc2">세틀뱅크 가입 후 전달받으신 개인정보 라이센스키를 입력해주세요.<br>결제 테스트를 위한 가맹점 라이센스키 발급은 <code><a target="_blank" href="https://develop.sbsvc.online/">세틀뱅크 개발자 사이트</a></code>에서 신청하실 수 있습니다.</code></div>', 'pgall-for-woocommerce' ),
						)
					)
				),
			);
