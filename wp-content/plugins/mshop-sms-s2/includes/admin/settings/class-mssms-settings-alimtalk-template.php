							...
							'left'     => array(
								...
								'elements'          => array(
									...
									array(
										...
										"desc2"       => __( "<div class='desc2' style='font-size: 11px;font-style: normal;'>[1] 이미지형<br>- 이미지 파일을 선택한 후 업로드 버튼을 클릭해주세요.<br>- 이미지 파일의 가로:세로 비율은 2:1 이며, 최소 크기는 가로 500px, 세로 250px 입니다.<br>[2] 강조표시형<br>- 메시지 최상단에 강조표시 타이틀 및 보조 문구가 기재됩니다.<br>- 강조표시 타이틀 및 보조 문구 이용 시 본문에 강조표시 타이틀 및 보조 문구와 동일한 문구가 포함되어 있어야 합니다.</div>", "mshop-sms-s2" ),
									),
									array(
										"id"        => "title",
