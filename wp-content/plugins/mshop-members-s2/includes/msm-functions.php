...
add_action( 'woocommerce_customer_reset_password', array( 'MSM_User_Login', 'woocommerce_customer_reset_password' ), 99 );
...
add_action( 'msm_action_register', array( 'MSM_User_Register', 'do_action' ), 10, 3 );
add_action( 'msm_action_login', array( 'MSM_User_Login', 'do_action' ), 10, 3 );
add_action( 'msm_action_lost_passwords', array( 'MSM_User_Password', 'lost_password_action' ), 10, 3 );
add_action( 'msm_action_temporary_password', array( 'MSM_User_Password', 'temporary_password_action' ), 10, 3 );
add_action( 'msm_action_ubsubscribe', array( 'MSM_User_Unsubscribe', 'do_action' ), 10, 3 );
add_action( 'msm_action_write_post', array( 'MFD_Action_Write_Post', 'do_action' ), 10, 3 );
add_action( 'msm_action_find_login', array( 'MSM_Find_Login', 'do_action' ), 10, 3 );
