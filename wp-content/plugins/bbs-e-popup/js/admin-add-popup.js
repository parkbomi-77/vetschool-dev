jQuery(document).ready(function() {
	...
	jQuery('#sub-title-user-2').tipsy({fade:true,gravity: 'e'});
...
var check_button=function(tNo){ // v2.1.5
	jQuery("input:radio[name='bbse_popup_close_button']").eq(tNo).prop( "checked", true );
}
