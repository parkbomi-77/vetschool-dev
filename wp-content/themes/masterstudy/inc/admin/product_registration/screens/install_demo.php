            ...
            <?php foreach ($demos as $demo_key => $demo_value): ?>
                ...
                <label class="<?php if ($demo_key == $current_demo) echo esc_attr('active'); ?>">
                    <div class="inner">
                        ...
                        <?php endif; ?>
                        <a href="<?php echo esc_url("https://stylemixthemes.com/masterstudy{$demo_value['href']}") ?>" class="stm_layout__label" target="_blank">
                            <?php echo esc_attr($demo_value['label']); ?>
                        </a>
                    </div>
                </label>
            <?php endforeach; ?>
    ...
    (function ($) {
        ...
        $(document).ready(function () {
            ...
            if (builder === 'elementor') {
                layout_plugins.push('masterstudy-elementor-widgets');
            }
            <?php endif; ?>
        ...
        function install_demo() {
            ...
            $.ajax({
                ...
                complete: function (data) {
                    ...
                    if(typeof dt.redirect !== 'undefined') {
                        window.location.replace(dt.redirect);
                    }
        ...
        $('.choose_plugin__choice').on('click', function (e) {
            ...
            if (builder === 'elementor') {
                ...
                var index_2 = layout_plugins.indexOf('masterstudy-elementor-widgets');
                if(index_1 != -1) {
                    layout_plugins.splice(index_1, 1);
                }
                if(index_2 != -1) {
